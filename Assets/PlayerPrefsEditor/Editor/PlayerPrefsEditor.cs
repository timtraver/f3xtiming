...
public class PlayerPrefsEditor : EditorWindow
{
	...
	private void DrawAddEntry()
	{
        ...
        bool keyboardAddPressed = Event.current.isKey && Event.current.keyCode == KeyCode.Return && (GUI.GetNameOfFocusedControl() == "newEntryKey" || GUI.GetNameOfFocusedControl() == "newEntryValue");
